...
public final class BenchmarksRTree_flatBufferRTreeCreation010_jmhTest {
    ...
    public BenchmarkTaskResult flatBufferRTreeCreation010_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_0.consume(l_benchmarksrtree0_G.flatBufferRTreeCreation010());
                res.allOps++;
            }

            flatBufferRTreeCreation010_thrpt_jmhStub(control, res, l_benchmarksrtree0_G, l_blackhole1_0);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "flatBufferRTreeCreation010", res.measuredOps, res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void flatBufferRTreeCreation010_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarksRTree_jmhType l_benchmarksrtree0_G, Blackhole_jmhType l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult flatBufferRTreeCreation010_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            BenchmarksRTree_jmhType l_benchmarksrtree0_G = _jmh_tryInit_f_benchmarksrtree0_G(control, threadParams);
            ...
            flatBufferRTreeCreation010_avgt_jmhStub(control, res, l_benchmarksrtree0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_benchmarksrtree0_G.flatBufferRTreeCreation010());
            ...
            res.measuredOps /= batchSize;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "flatBufferRTreeCreation010", res.measuredOps, res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void flatBufferRTreeCreation010_avgt_jmhStub(InfraControl control, RawResults result, BenchmarksRTree_jmhType l_benchmarksrtree0_G, Blackhole_jmhType l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult flatBufferRTreeCreation010_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            BenchmarksRTree_jmhType l_benchmarksrtree0_G = _jmh_tryInit_f_benchmarksrtree0_G(control, threadParams);
            ...
            flatBufferRTreeCreation010_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_benchmarksrtree0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_benchmarksrtree0_G.flatBufferRTreeCreation010());
            ...
            res.measuredOps *= opsPerInv;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "flatBufferRTreeCreation010", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void flatBufferRTreeCreation010_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, BenchmarksRTree_jmhType l_benchmarksrtree0_G, Blackhole_jmhType l_blackhole1_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult flatBufferRTreeCreation010_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmhType l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            BenchmarksRTree_jmhType l_benchmarksrtree0_G = _jmh_tryInit_f_benchmarksrtree0_G(control, threadParams);
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            flatBufferRTreeCreation010_ss_jmhStub(control, batchSize, res, l_benchmarksrtree0_G, l_blackhole1_0);
            control.preTearDown();
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "flatBufferRTreeCreation010", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void flatBufferRTreeCreation010_ss_jmhStub(InfraControl control, int batchSize, RawResults result, BenchmarksRTree_jmhType l_benchmarksrtree0_G, Blackhole_jmhType l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
