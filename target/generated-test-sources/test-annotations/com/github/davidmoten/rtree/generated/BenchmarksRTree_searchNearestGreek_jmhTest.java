...
public final class BenchmarksRTree_searchNearestGreek_jmhTest {
    ...
    public BenchmarkTaskResult searchNearestGreek_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_benchmarksrtree0_G.searchNearestGreek(l_blackhole1_1);
                res.allOps++;
            }

            searchNearestGreek_thrpt_jmhStub(control, res, l_blackhole1_1, l_benchmarksrtree0_G, l_blackhole1_0);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "searchNearestGreek", res.measuredOps, res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void searchNearestGreek_thrpt_jmhStub(InfraControl control, RawResults result, Blackhole_jmhType l_blackhole1_1, BenchmarksRTree_jmhType l_benchmarksrtree0_G, Blackhole_jmhType l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult searchNearestGreek_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            BenchmarksRTree_jmhType l_benchmarksrtree0_G = _jmh_tryInit_f_benchmarksrtree0_G(control, threadParams);
            ...
            searchNearestGreek_avgt_jmhStub(control, res, l_blackhole1_1, l_benchmarksrtree0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_benchmarksrtree0_G.searchNearestGreek(l_blackhole1_1);
            ...
            res.measuredOps /= batchSize;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "searchNearestGreek", res.measuredOps, res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void searchNearestGreek_avgt_jmhStub(InfraControl control, RawResults result, Blackhole_jmhType l_blackhole1_1, BenchmarksRTree_jmhType l_benchmarksrtree0_G, Blackhole_jmhType l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult searchNearestGreek_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            RawResults res = new RawResults();
            Blackhole_jmhType l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            BenchmarksRTree_jmhType l_benchmarksrtree0_G = _jmh_tryInit_f_benchmarksrtree0_G(control, threadParams);
            ...
            searchNearestGreek_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_blackhole1_1, l_benchmarksrtree0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_benchmarksrtree0_G.searchNearestGreek(l_blackhole1_1);
            ...
            res.measuredOps *= opsPerInv;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "searchNearestGreek", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void searchNearestGreek_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, Blackhole_jmhType l_blackhole1_1, BenchmarksRTree_jmhType l_benchmarksrtree0_G, Blackhole_jmhType l_blackhole1_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult searchNearestGreek_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmhType l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            BenchmarksRTree_jmhType l_benchmarksrtree0_G = _jmh_tryInit_f_benchmarksrtree0_G(control, threadParams);
            Blackhole_jmhType l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            searchNearestGreek_ss_jmhStub(control, batchSize, res, l_blackhole1_1, l_benchmarksrtree0_G, l_blackhole1_0);
            control.preTearDown();
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "searchNearestGreek", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void searchNearestGreek_ss_jmhStub(InfraControl control, int batchSize, RawResults result, Blackhole_jmhType l_blackhole1_1, BenchmarksRTree_jmhType l_benchmarksrtree0_G, Blackhole_jmhType l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
